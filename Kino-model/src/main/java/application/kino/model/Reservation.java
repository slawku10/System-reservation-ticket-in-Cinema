...
@NamedQueries({
    ...
    , @NamedQuery(name = "Reservation.findByUser", query = "SELECT r FROM Reservation r WHERE r.idUser.id = :userId")
    , @NamedQuery(name = "Reservation.findByShowing", query = "SELECT r FROM Reservation r WHERE r.idShowing.id = :showingId")})
